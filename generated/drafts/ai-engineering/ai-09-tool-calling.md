...
What is it?
Tool calling (also called function calling) lets a model request that your code run a function. You describe the tools you offer. The model replies with a tool name and arguments, as structured output (#08). Your code runs the function and sends the result back.
