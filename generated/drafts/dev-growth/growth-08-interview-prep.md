...
Then do reps — six to eight problems per pattern, not sixty. Enough that you recognise the shape, not so many that you are memorising solutions.

Then simulate. Out loud, on a timer, explaining as you go. The gap between "I solved it" and "I explained it while solving it" is the gap most people fail in.
...
I mistook a long problem count for progress. The number that actually moved me was how many problems I could look at and say "that is a sliding window" within thirty seconds.
