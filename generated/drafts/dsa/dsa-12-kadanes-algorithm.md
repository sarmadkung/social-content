...
The link to post #11: sum of a[l..r] = pre[r + 1] − pre[l]. So the best subarray is the biggest gap between a running total and the smallest total before it. Kadane is that idea without storing the array.
...
Next: Boyer–Moore Voting — find the majority element with the same "reset" trick.
