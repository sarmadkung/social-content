...
You're asking "have I seen this number before?" That's a lookup. And a lookup against an array is O(n), while a lookup against a hash map is O(1) on average (post #05 showed why).
