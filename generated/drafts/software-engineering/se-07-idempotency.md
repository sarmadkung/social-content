...
Why do we need it?
Timeouts and retries (#04, #05) mean the same request can arrive more than once. A timeout does not tell you if the work happened. Without idempotency, "try again" can create two orders, two emails, or two charges.
