...
What is it?
A vector database stores embeddings (#07) and finds the ones closest to a query vector. That search is called similarity search, or nearest-neighbour search.
