SERIES:    SOFTWARE ENGINEERING #06
...
STATUS:    draft
---
Last post: your payment call times out, and you don't know if the customer was charged. A blind retry might charge them twice.
...
Why do we need it?
Timeouts and retries (#03, #04) mean the same request can arrive more than once. A timeout does not tell you if the work happened. Without idempotency, "try again" can create two orders, two emails, or two charges.
