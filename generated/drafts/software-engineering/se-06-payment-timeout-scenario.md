...
First, what a timeout tells you (#04): only that you stopped waiting. The request may have:
...
Retry the charge right away. The retry helper from #05 would happily do it. If case 3 happened, the customer now pays $98.
