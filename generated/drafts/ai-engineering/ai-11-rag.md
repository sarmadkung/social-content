...
2. Turn each chunk into an embedding (#07) and store it.
At question time:
...
Link to #09: your code can always search first. Or you give the model a search tool and let it decide when to look.
